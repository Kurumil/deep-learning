...
plant_dataset = PlantDataset("plant_data", "train")
...
train_dataloader = DataLoader(PlantDataset(root="plant_data", phase="train", transformation=train_transformation), batch_size=64, shuffle=True)
test_dataloader = DataLoader(PlantDataset(root="plant_data", phase="test", transformation=test_transformation), batch_size=64, shuffle=False)
